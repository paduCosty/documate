    ...
    <GuestLayout>
      <div className="w-full max-w-[400px] rounded-2xl border border-zinc-800 bg-zinc-900 p-8 shadow-[0_0_0_1px_#3f3f46,0_16px_48px_rgba(0,0,0,0.6)]">
        ...
        <form onSubmit={submit} className="mt-8 space-y-4">
          ...
          <DocumateButton className="mt-6 w-full" disabled={processing || !data.terms}>
        ...
        {/* Google Sign Up */}
        <a href="/auth/google" className="mt-6 flex w-full items-center justify-center gap-2 rounded-xl border border-zinc-700 py-2.5 text-sm font-medium text-zinc-300 transition-colors hover:bg-zinc-800">
