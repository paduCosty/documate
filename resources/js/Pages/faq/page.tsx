...
const faqs = [
  ...
  { category: "General", question: "Do I need to create an account?", answer: "No, you can use basic tools without an account. Creating a free account is free forever. Upgrade to Pro for unlimited operations, or buy credits for pay-as-you-go access." },
  ...
  { category: "Security", question: "Are my files secure?", answer: "Yes. All files are encrypted with 256-bit SSL during upload and processing. Files are automatically deleted from our servers after 24 hours for privacy." },
  ...
  { category: "Tools", question: "Can I merge more than 10 files?", answer: "All users can merge up to 10 files at once in a single operation." },
