      ...
      <div className="px-8 py-10">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <DocumateBadge>{hasActiveSubscription ? "Pro" : "Free"}</DocumateBadge>
        ...
        {/* Usage Card - Different for Free vs Pro Users */}
        {hasActiveSubscription ? (
          <DocumateCard className="mt-4 border-green-700/50 bg-green-950/20">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm text-green-400 font-medium">Unlimited</span>
            </div>
            <p className="mt-3 text-xs text-zinc-400">
              Enjoy unlimited PDF operations, priority processing, and premium features.
            </p>
          </DocumateCard>
        ) : (
