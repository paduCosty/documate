...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <meta property="og:url" content="https://documate.nexkit.app">
        <meta property="og:image" content="https://documate.nexkit.app/og-image.png">
        ...
        <meta name="twitter:image" content="https://documate.nexkit.app/og-image.png">
